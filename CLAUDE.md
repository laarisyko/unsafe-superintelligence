...
| `openclaw-workspace/` | AGENTS.md + TOOLS.md for drop-in workspace integration | Markdown |
...
- **Sybil resistance:** Proof-of-work admission controller (`engine/openclaw_engine/training/sybil.py`)
...
- `network/gossip.rs` — Topic definitions: `openclaw/heartbeat`, `openclaw/training`, `openclaw/gradient`, `openclaw/checkpoint`, `openclaw/architecture`
...
## Python Engine Internals (`engine/openclaw_engine/`)
...
6. No live dashboard at openclaw.org
...
- `PLAN-OPENCLAW-INTEGRATION.md` — OpenClaw platform integration (skill, plugin, webhook)
